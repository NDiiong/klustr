...
export const COLOR_PALETTE: Record<TagColor, ColorClasses> = {
  ...
  lime: {
    ...
    badgeClass: 'border-lime-500/20 bg-lime-500/10 text-lime-500',
  ...
  teal: {
    ...
    badgeClass: 'border-teal-500/20 bg-teal-500/10 text-teal-500',
    barClass: 'bg-teal-500',
  },
  cyan: {
    dotClass: 'bg-cyan-500',
    badgeClass: 'border-cyan-500/20 bg-cyan-500/10 text-cyan-500',
  ...
  blue: {
    ...
    badgeClass: 'border-blue-500/20 bg-blue-500/10 text-blue-500',
    barClass: 'bg-blue-500',
  },
  indigo: {
    dotClass: 'bg-indigo-500',
    badgeClass: 'border-indigo-500/20 bg-indigo-500/10 text-indigo-500',
  ...
  fuchsia: {
    ...
    badgeClass: 'border-fuchsia-500/20 bg-fuchsia-500/10 text-fuchsia-500',
    barClass: 'bg-fuchsia-500',
  },
  pink: {
    dotClass: 'bg-pink-500',
    badgeClass: 'border-pink-500/20 bg-pink-500/10 text-pink-500',
